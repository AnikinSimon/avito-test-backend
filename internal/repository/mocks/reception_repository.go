...
import (
	...
	sqlc "github.com/AnikinSimon/avito-test-backend/internal/repository/sqlc"
...
func (m *MockReceptionQueries) AddProductToReception(ctx context.Context, arg sqlc.AddProductToReceptionParams) (sqlc.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockReceptionQueries) CreateReception(ctx context.Context, arg sqlc.CreateReceptionParams) (sqlc.Reception, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateReception", ctx, arg)
	ret0, _ := ret[0].(sqlc.Reception)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockReceptionQueries) FinishReception(ctx context.Context, pvzID uuid.UUID) (sqlc.Reception, error) {
	m.ctrl.T.Helper()
...
func (m *MockReceptionQueries) GetLastProductInReception(ctx context.Context, receptionID uuid.UUID) (sqlc.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockReceptionQueries) GetOpenReceptionByPvzID(ctx context.Context, pvzID uuid.UUID) (sqlc.Reception, error) {
	m.ctrl.T.Helper()
...
func (m *MockReceptionQueries) SearchReceptionsByPvzsAndTime(ctx context.Context, arg sqlc.SearchReceptionsByPvzsAndTimeParams) ([]sqlc.Reception, error) {
	m.ctrl.T.Helper()
