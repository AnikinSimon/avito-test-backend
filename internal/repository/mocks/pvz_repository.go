...
func (m *MockPvzQueries) CreatePVZ(ctx context.Context, arg sqlc.CreatePVZParams) (sqlc.Pvz, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePVZ", ctx, arg)
	ret0, _ := ret[0].(sqlc.Pvz)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPvzQueries) SearchPVZ(ctx context.Context, arg sqlc.SearchPVZParams) ([]sqlc.Pvz, error) {
	m.ctrl.T.Helper()
